...
//creo una costante in cui richiamo la funzione per il router
...
//creo store con post
router.post('/', (req, res) => {
    res.send('Salva un nuovo prodotto');
});
...
router.put('/:id', (req, res) => {
    ...
    res.send(`Modifico il prodotto con l'id : ${id}`);
});

//creo modify con patch
